...
def letter_stat(our_str):
    ...
    for i in our_str:  # Пробегаем по буквам строки our_str, попадающей на вход
        letters_dict[i] = our_str.count(i)  # Добавляем в словарь ключ, соответствующий букве из строки our_str и значение, сответствующее кол-ву вхождений символа в строку (подсчет символов при помощи вызова .count) 
