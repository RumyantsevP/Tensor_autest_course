...
def repeats(our_str):
    ...
    for i in our_str:  # Пробегаем по символам строки our_str, попадающей на вход
        ...
        new_dict[i] = new_str.count(i)  # Добавляем в словарь ключ, соответствующий букве из строки new_str и значение, сответствующее кол-ву вхождений символа в строку (подсчет символов при помощи вызова .count)
